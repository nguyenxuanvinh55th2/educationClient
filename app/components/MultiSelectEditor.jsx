  ...
  render(){
    ...
    return (
      <div style={{display: 'flex', flexDirection: 'column', backgroundColor: 'white', height: 'inherit', border: '1px solid grey'}}>
        ...
        <input ref="userMails" type="text" style={{width: '100%'}} placeholder="Nhập email và nhấn enter để gửi mail mới sinh viên"
          onBlur={() => that.props.onChangeValue(this.state.userMails)}
          onKeyPress={(event)=>this.handleKeyPress(event)}
            style={{width: '100%', border: 0, borderTop: this.state.userMails.length ? '1px solid grey': 0 , minHeight: 20}}/>
      </div>
    )
  }
}
