...
const getMetaTags = ({
  title, description, url, contentType, published, updated, category, tags, twitter, seoImages
}) => {
  const metaTags = [
    { itemprop: 'name', content: title },
    { itemprop: 'description', content: description },
    { itemprop: 'image', content: seoImages },
    ...
    { name: 'twitter:image:src', content: seoImages },
    { name: 'og:title', content: `${title} | The Meteor Chef` },
    { name: 'og:type', content: contentType },
    { name: 'og:url', content: url },
    { name: 'og:image', content: seoImages },
    { name: 'og:description', content: description },
    { name: 'og:site_name', content: 'The Meteor Chef' },
    { name: 'fb:app_id', content: '267426847100050' },
  ];
...
const SEO = ({
  schema, title, description, path, contentType, published, updated, category, tags, twitter, seoImages
}) => (
  <Helmet
