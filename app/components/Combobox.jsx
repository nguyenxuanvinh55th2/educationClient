            ...
            if (this.refs[this.props.name].value) {
                __.forEach(this.refs[this.props.datalistName].options, (option) => {
                    if (option.value == this.refs[this.props.name].value) {
                        ...
                        this.props.getValue(option.dataset.value, value);
                    }
                });
            }
            if(!__.find(this.refs[this.props.datalistName].options, {value: this.refs[this.props.name].value})) {
              this.props.getValue(null, value);
            }
        } else {
            this.props.getValue(null, null);
        }
    }
    render() {
