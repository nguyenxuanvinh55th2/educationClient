...
class TermsForm extends React.Component {
  ...
  handleSave(){
    Settings.update({_id: 'buildmodify'}, {$set: {terms: this.state.content}});
  }
  componentWillReceiveProps(nextProps){
    if(nextProps.data.setting){
      this.setState({content: nextProps.data.setting.terms ? nextProps.data.setting.terms : '', loading: false})
    }
  }
  render(){
        ...
        <div>
          <div style={{
            ...
            <ol className="breadcrumb" style={{
              ...
              <li>
                <a onClick={() => browserHistory.push('/termsForm')}>Điều khoản chung</a>
              </li>
            </ol>
            <div style={{
              display: 'flex',
          ...
          <div className="row" style={{
            ...
            <QuillEditorTour keyValue={"terms"} ref="terms" height={window.innerHeight - 230} value={this.state.content} getValue={(value) => {
