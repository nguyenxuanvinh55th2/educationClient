...
const fileImageFile = 'https://sv1.upsieutoc.com/2017/10/12/file.png';
                          ...
                          <div key={idx} style={{backgroundColor: 'white', marginTop: 10, padding: 10}}>
                            <ListItem style={{fontSize: 13}}
                              innerDivStyle={{padding: '5px 16px 5px 50px'}}
                               leftAvatar={<Avatar src={topic.owner && topic.owner.image ? topic.owner.image : 'https://sv1.upsieutoc.com/2017/10/12/userImage.png'} backgroundColor={'#35bcbf'} style={{top: 5, left: 7}} />}
                               primaryText={
                                 <p>
                                  {
                               ...
                               }}>Bình luận({topic.memberReply.length})</button>
                               {
                                 ...
                                 <div>
                                     ...
                                     __.map(topic.memberReply,(reply, index) => {
                                       return (
                                         <div key={index} style={{display: 'flex', flexDirection: 'row', justifyContent: 'flex-start', paddingTop: 10}}>
                                           <img src={reply.owner && reply.owner.image ? reply.owner.image : 'https://sv1.upsieutoc.com/2017/10/12/userImage.png'} width="30" height="30" />
                                   ...
                                   <div style={{display: 'flex', flexDirection: 'row', justifyContent: 'flex-start', paddingTop: 10}}>
                                     <img src="https://sv1.upsieutoc.com/2017/10/12/userImage.png" width="30" height="30" style={{marginTop: 7}} />
                      ...
                      __.map(dataSet.getTeacherByClassSubject, (infoUser,idx) => {
                        return (
                          <div key={idx} style={{display: 'flex', flexDirection: 'row', justifyContent: 'flex-start', width: '100%', border: '2px solid white', padding: 10}}>
                            <div>
                              <img src={infoUser.image ? infoUser.image : 'https://sv1.upsieutoc.com/2017/10/12/userImage.png'} height="75" width="75" className="img-responsive"/>
                            </div>
